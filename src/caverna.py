...
class Caverna:
    ...
    def cria_caverna(self):
        ...
        self.tunel = {
            ...
            Tunel(self.html, "tunel_%d %d" % par_ordenado, self.sala,
...
class Camara:
    ...
    def cria_camara(self):
        ...
        self.div.text = "Eai Jeniffer %s" % self.nome
...
class Tunel:
    ...
    def __init__(self, html, nome, lugar, par_ordenado, caverna):
        ...
        self.camara = {}
        self.lugar0 = self.caverna.camara[
        'camara_%d'% par_ordenado[0]]

        self.lugar1 = self.caverna.camara[
            'camara_%d'% par_ordenado[1]]
    ...
    def cria_tunel(self):
        ...
        self.div.style.width = 1000
        self.div.style.height = 800
        self.div.text = "Caverna da Jeniffer! %s" % self.nome
        self.div <= self.passagem
        self.cria_saida()
        return self
